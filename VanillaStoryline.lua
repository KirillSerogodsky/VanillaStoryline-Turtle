...
function storyline:OnUpdate()
	...
	if storyline.Options.Fading == 1 and storyline.Variables.LastTime + storyline.Options.Delay <= storyline.Variables.Time then
		...
		storyline.Variables.SliderProgress = storyline.Variables.SliderProgress +
			((storyline.Variables.FontSize / 14) * storyline.Options.TextSpeed / 3)

		-- set Slider Progression
		if storyline.Variables.SliderStop == 0 then
			storyline.Background.layer5.Questtext.Slider:SetValue(storyline
				.Variables.SliderProgress - 50)
		end

		-- Set Font Fading
		storyline.Text.Questtext.Font:SetAlphaGradient(storyline.Variables.fadingProgress,
			storyline.Options.GradientLength)
...
function storyline.Background:ConfigureFrame()
	...
	self.layer5.Questtext.Fade.Button:SetScript("OnLeave",
		function() self.layer5.Questtext:SetBackdropBorderColor(1, 1, 1, 1) end)
	...
	self.OptionsButton:SetScript("OnClick", function()
		PlaySound("igMainMenuOptionCheckBoxOn")
		if storyline.OptionsFrame:IsVisible() then
			storyline.OptionsFrame:Hide()
		else
			storyline.UpdateOptions(); storyline.OptionsFrame:Show()
		end
	end)
end
...
function storyline.Gossip:ConfigureFrame()
	...
	local backdrop = {
		bgFile =
		"Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\UI-GuildAchievement-Parchment-Horizontal",
		edgeFile =
		"Interface\\GLUES\\COMMON\\TextPanel-Border",
		tile = false,
		tileSize = 16,
	...
	for i = 1, 32 do
		...
		if i == 1 then
			...
			self.Frame.Scrollframe.Content.Block[i] = CreateFrame("Frame", nil, self.Frame.Scrollframe.Content.Block
				[i - 1])
			self.Frame.Scrollframe.Content.Block[i]:SetPoint("BOTTOMLEFT", 0, -18)
		end
		...
		self.Frame.Scrollframe.Content.Block[i].Button = CreateFrame("Button", nil,
			self.Frame.Scrollframe.Content.Block[i])
		...
		self.Frame.Scrollframe.Content.Block[i].Button:SetHighlightTexture(
			"Interface\\Questframe\\UI-QuestTitleHighlight")
		self.Frame.Scrollframe.Content.Block[i].Button:SetScript("OnClick",
			function() PlaySound("igMainMenuOptionCheckBoxOn"); end)
		...
		self.Frame.Scrollframe.Content.Block[i].Icon.Texture = self.Frame.Scrollframe.Content.Block[i].Icon
			:CreateTexture()
		...
		self.Frame.Scrollframe.Content.Block[i].Font = self.Frame.Scrollframe.Content.Block[i]:CreateFontString(nil,
			"OVERLAY")
...
function storyline:updateGossip()
	...
	local function setQuests(...)
		for i = 1, arg.n, 2 do
			...
			ID = ID + 1
			local ChooseID = ID
			storyline.Gossip.Frame.Scrollframe.Content.Block[counter].Icon.Texture:SetTexture(
			...
			storyline.Gossip.Frame.Scrollframe.Content.Block[counter].Button:SetScript("OnClick",
				function()
					PlaySound("igMainMenuOptionCheckBoxOn"); GossipTitleButton_OnClick()
				end)
	...
	local function setOptions(...)
		for i = 1, arg.n, 2 do
			...
			ID = ID + 1
			local ChooseID = ID
			storyline.Gossip.Frame.Scrollframe.Content.Block[counter].Icon.Texture:SetTexture("Interface\\GossipFrame\\" ..
				arg[i + 1] .. "GossipIcon")
			storyline.Gossip.Frame.Scrollframe.Content.Block[counter].Font:SetText(arg[i])
			storyline.Gossip.Frame.Scrollframe.Content.Block[counter].Button:SetID(ChooseID)
	...
	if storyline.Variables.GreetingsFlag == 1 then
		...
		for i = 1, numActiveQuests do
			...
			storyline.Gossip.Frame.Scrollframe.Content.Block[counter].Button:SetScript("OnClick",
				function()
					PlaySound("igMainMenuOptionCheckBoxOn"); QuestTitleButton_OnClick()
				end)
			storyline.Gossip.Frame.Scrollframe.Content.Block[counter]:Show()
		end
	...
	for i = 1, counter do
		storyline.Gossip.Frame.Scrollframe.Content.Block[i].Button:SetHeight(storyline.Gossip.Frame.Scrollframe.Content
			.Block[i].Font:GetHeight())
		storyline.Gossip.Frame.Scrollframe.Content.Block[i]:SetHeight(storyline.Gossip.Frame.Scrollframe.Content.Block
			[i].Font:GetHeight() + 2)
	end
...
function storyline.QuestDetail:ConfigureFrame()
	...
	self.GetQuest.Accept.Button:SetHighlightTexture(
		"Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\PetBattle-SelectedPetGlow")
	...
	self.GetQuest.Accept.Button:SetScript("OnClick",
		function()
			PlaySound("igMainMenuOptionCheckBoxOn"); AcceptQuest(); storyline.Background:Hide()
		end)
	...
	self.GetQuest.Decline.Button:SetHighlightTexture(
		"Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\PetBattle-SelectedPetGlow")
	...
	self.GetQuest.Decline.Button:SetScript("OnClick", function()
		storyline:DeclineQuest(); PlaySound("igQuestCancel");
	end)
	...
	local backdrop = {
		bgFile =
		"Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\PandarenTrainingLarge_Circular_Frame"
	}
...
function storyline.QuestProgress:ConfigureFrame()
	...
	self.Mainframe.Objective.Block[1].TextFont = self.Mainframe.Objective.Block[1].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Objective.Block[2].TextFont = self.Mainframe.Objective.Block[2].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Objective.Block[3].TextFont = self.Mainframe.Objective.Block[3].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Objective.Block[4].TextFont = self.Mainframe.Objective.Block[4].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Objective.Block[5].TextFont = self.Mainframe.Objective.Block[5].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Objective.Block[6].TextFont = self.Mainframe.Objective.Block[6].TextBackground:CreateFontString(nil,
		"OVERLAY")
...
function storyline.QuestComplete:ConfigureFrame()
	...
	self.Mainframe.CenterFlash.Flash:SetTexture(
	...
	self.Mainframe.Reward.Money.Copper.Font = self.Mainframe.Reward.Money.Copper:CreateFontString(nil, "OVERLAY",
	...
	self.Mainframe.Reward.Money.Silver.Font = self.Mainframe.Reward.Money.Silver:CreateFontString(nil, "OVERLAY",
		"NumberFontNormalLarge")
	...
	self.Mainframe.Reward.Money.Gold.Font = self.Mainframe.Reward.Money.Gold:CreateFontString(nil, "OVERLAY",
		"NumberFontNormalLarge")
	...
	self.Mainframe.Reward.Block[1].TextFont = self.Mainframe.Reward.Block[1].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Reward.Block[2].TextFont = self.Mainframe.Reward.Block[2].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Reward.Block[3].TextFont = self.Mainframe.Reward.Block[3].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Reward.Block[4].TextFont = self.Mainframe.Reward.Block[4].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Reward.Block[5].TextFont = self.Mainframe.Reward.Block[5].TextBackground:CreateFontString(nil,
		"OVERLAY")
	...
	self.Mainframe.Reward.Block[6].TextFont = self.Mainframe.Reward.Block[6].TextBackground:CreateFontString(nil,
		"OVERLAY")
...
function storyline.OptionsFrame:ConfigureFrame()
	...
	self.SpeedSlider:SetScript("OnValueChanged", function()
		storyline.Options.TextSpeed = storyline.OptionsFrame.SpeedSlider:GetValue() / 10; StorylineOptions.TextSpeed =
			storyline.Options.TextSpeed
		getglobal("StorylineSpeedSlider" .. 'Text'):SetText(storyline.Options.TextSpeed)
	end)
	...
	self.ScaleSlider:SetScript("OnValueChanged", function()
		storyline.Options.WindowScale = storyline.OptionsFrame.ScaleSlider:GetValue() / 100; StorylineOptions.WindowScale =
			storyline.Options.WindowScale
		getglobal("StorylineScaleSlider" .. 'Text'):SetText(storyline.Options.WindowScale * 100 .. " %")
	end)
	...
	self.MoveButton:SetScript("OnClick", function()
		PlaySound("igMainMenuOptionCheckBoxOn")
		if self.MoveButton:GetChecked() then
			storyline.Background:EnableMouse(1); storyline.Background.layer2.Background:EnableMouse(0)
		else
			storyline.Background:EnableMouse(0); storyline.Background.layer2.Background:EnableMouse(1)
		end
	end)
	...
	self.HideButton:SetScript("OnClick", function()
		PlaySound("igMainMenuOptionCheckBoxOn")
		if self.HideButton:GetChecked() then
			storyline.Options.HideBlizzardFrames = 1; StorylineOptions.HideBlizzardFrames = 1
		else
			storyline.Options.HideBlizzardFrames = 0; StorylineOptions.HideBlizzardFrames = 0; DeclineQuest(); PlaySound(
				"igQuestCancel");
		end
		storyline:HideBlizzard()
	end)
	...
	if storyline.Options.HideBlizzardFrames == 1 then
		self.HideButton:SetChecked(1)
	else
		self.HideButton:SetChecked(0)
	end
	...
	self.InstantRewardsButton:SetScript("OnClick", function()
		...
		if StorylineOptions.InstantRewards == 0 then
			StorylineOptions.InstantRewards = 1
		else
			StorylineOptions.InstantRewards = 0; PlaySound("igQuestCancel");
		end
	end)
	...
	if StorylineOptions.InstantRewards == 1 then
		self.InstantRewardsButton:SetChecked(1)
	else
		self.InstantRewardsButton:SetChecked(0)
	end
	...
	if pfUI and pfUI.uf then
		...
		self.PFHideButton:SetScript("OnClick", function()
			PlaySound("igMainMenuOptionCheckBoxOn")
			if pfUI_config["disabled"]["skin_Gossip and Quest"] == "0" then
				pfUI_config["disabled"]["skin_Gossip and Quest"] = "1"
			else
				pfUI_config["disabled"]["skin_Gossip and Quest"] = "0"; DeclineQuest(); PlaySound("igQuestCancel");
			end
		...
		if pfUI_config["disabled"]["skin_Gossip and Quest"] == "1" then
			self.PFHideButton:SetChecked(1)
		else
			self.PFHideButton:SetChecked(0)
		end
	end
	...
	if StorylineOptions.EnableModelManip == 1 then
		self.ModelManipButton:SetChecked(1)
	else
		self.ModelManipButton:SetChecked(0)
	end
...
function storyline.UpdateOptions()
	if QUEST_FADING_DISABLE == "0" then
		storyline.OptionsFrame.InstantTextButton:SetChecked(0); storyline.OptionsFrame.SpeedSlider:Show(); storyline
			.OptionsFrame.SpeedFont:Show()
	else
		storyline.OptionsFrame.InstantTextButton:SetChecked(1); storyline.OptionsFrame.SpeedSlider:Hide(); storyline
			.OptionsFrame.SpeedFont:Hide()
	end
end
...
function storyline:AcceptQuest()
	...
	storyline.Background.layer5.Questtext.Fade.Button:SetScript("OnLeave",
		function()
...
function storyline:AcceptQuestOnClick()
	...
	storyline.Background.layer5.Questtext.Fade.Button:SetScript("OnLeave",
		function() storyline.Background.layer5.Questtext:SetBackdropBorderColor(1, 1, 1, 1) end)
	storyline.Background.layer5.Questtext.Fade.Button:SetScript("OnClick", function() end)
	storyline.Text.Questtext.Continue:Hide()
...
function storyline:ProgressQuest()
	...
	storyline.Background.layer5.Questtext.Fade.Button:SetScript("OnClick",
		function() storyline:ProgressQuestObjectives() end)
	storyline.Background.layer5.Questtext:SetBackdropBorderColor(1, 1, 1, 1)
	storyline.Text.Questtext.Continue:Show()
	storyline.Text.Questtext.Complete:Hide()
	...
	if IsQuestCompletable() then
		storyline.QuestProgress.Mainframe.State:SetBackdrop({
			bgFile = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\ReadyCheck-Ready"
		})
	else
		storyline.QuestProgress.Mainframe.State:SetBackdrop({
			bgFile = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\ReadyCheck-NotReady"
		})
	end
...
function storyline:ProgressQuestObjectives()
	...
	if IsQuestCompletable() then
		...
		storyline.QuestProgress.Mainframe.State:SetBackdrop({
			bgFile =
			"Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\ReadyCheck-NotReady"
		})
	end
end
...
function storyline:CompleteQuest()
	...
	storyline.Background.layer5.Questtext.Fade.Button:SetScript("OnClick",
		function()
			QuestRewardCompleteButton_OnClick(); DressUpFrame:Hide()
		end)
	storyline.Background.layer5.Questtext:SetBackdropBorderColor(1, 1, 1, 1)
	storyline.Text.Questtext.Continue:Hide()
	storyline.Text.Questtext.Complete:Show()
...
function storyline:UpdateReqItems()
	...
	if numRequiredItems > 0 then
		...
		if numRequiredMoney > 0 then
			counter = counter + 1
			storyline.QuestProgress.Mainframe.Objective.Block[counter].Item:SetBackdrop({
				bgFile =
...
function storyline:UpdateRewardItems()
	...
	if gold == 0 then
		storyline.QuestComplete.Mainframe.Reward.Money.Gold:Hide()
	else
		storyline.QuestComplete.Mainframe
			.Reward.Money.Gold:Show()
	end
	if gold == 0 and silver == 0 then
		storyline.QuestComplete.Mainframe.Reward.Money.Silver:Hide()
	else
		storyline
			.QuestComplete.Mainframe.Reward.Money.Silver:Show()
	end
	...
	if money > 0 then
		...
		storyline.QuestComplete.Mainframe.Reward.Money:Hide()
	end
	...
	for i = 1, numQuestChoices do
		...
		if not isUsable then
			storyline.QuestComplete.Mainframe.Reward.Block[counter].Item:SetBackdropColor(1, 0, 0, 1)
		else
			storyline.QuestComplete.Mainframe.Reward.Block[counter].Item:SetBackdropColor(1, 1, 1, 1)
		end
		...
		storyline.QuestComplete.Mainframe.Reward.Block[counter].Item.Button:SetScript("OnLeave",
			function()
				GameTooltip:Hide(); ResetCursor()
			end)
		storyline.QuestComplete.Mainframe.Reward.Block[counter].Item.Button:SetScript("OnClick",
			function() storyline:QuestReward_OnClick() end)
...
function storyline:ConfigureModelRotation()
	if StorylineOptions.EnableModelManip == 1 then
		storyline:EnableModelManipulation()
	else
		storyline:DisableModelManipulation()
	end
end
...
function storyline:UpdateModels()
	if UnitExists("npc") then
		storyline.NPC.PlayerFrame:SetUnit("npc")
	else
		storyline.NPC.PlayerFrame:SetModel("Interface\\Buttons\\talktomequestionmark.mdx")
	end
	...
	if model == "Character\\Dwarf\\Female\\DwarfFemale" then
		storyline.Player.PlayerFrame:SetModelScale(0.9)
	elseif model == "Character\\Dwarf\\Male\\DwarfMale" then
		storyline.Player.PlayerFrame:SetModelScale(0.9)
	elseif model == "Character\\Gnome\\Female\\GnomeFemale" then
		storyline.Player.PlayerFrame:SetModelScale(0.75)
	elseif model == "Character\\Gnome\\Male\\GnomeMale" then
		storyline.Player.PlayerFrame:SetModelScale(0.75)
	elseif model == "Character\\Human\\Female\\HumanFemale" then
		storyline.Player.PlayerFrame:SetModelScale(0.95)
	elseif model == "Character\\Human\\Male\\HumanMale" then
		storyline.Player.PlayerFrame:SetModelScale(1.02)
	elseif model == "Character\\NightElf\\Male\\NightElfMale" then
		storyline.Player.PlayerFrame:SetModelScale(1.07)
	elseif model == "Character\\Orc\\Female\\OrcFemale" then
		storyline.Player.PlayerFrame:SetModelScale(0.95)
	elseif model == "Character\\Orc\\Male\\OrcMale" then
		storyline.Player.PlayerFrame:SetModelScale(0.97)
	elseif model == "Character\\Scourge\\Female\\ScourgeFemale" then
		storyline.Player.PlayerFrame:SetModelScale(1.02)
	elseif model == "Character\\Scourge\\Male\\ScourgeMale" then
		storyline.Player.PlayerFrame:SetModelScale(0.97)
	elseif model == "Character\\Tauren\\Female\\TaurenFemale" then
		storyline.Player.PlayerFrame:SetModelScale(1.12)
	elseif model == "Character\\Tauren\\Male\\TaurenMale" then
		storyline.Player.PlayerFrame:SetModelScale(1.14)
	elseif model == "Character\\Troll\\Female\\TrollFemale" then
		storyline.Player.PlayerFrame:SetModelScale(1.05)
	end
	...
	if model == "Interface\\Buttons\\talktomequestionmark" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.9, 0); storyline.NPC.PlayerFrame:SetModelScale(2) -- ok with scalebug
	elseif model == "Creature\\GnomeSpidertank\\GnomeBot" then
		storyline.NPC.PlayerFrame:SetPosition(-4, -5.4, 0); storyline.NPC.PlayerFrame:SetModelScale(0.6) -- ok with scalebug		
		-- Onu from Darkshore used to test
	elseif model == "Creature\\AncientOfLore\\AncientofLore" then
		storyline.NPC.PlayerFrame:SetPosition(0, 2.0, 3.9); storyline.NPC.PlayerFrame:SetModelScale(0.35) -- ok with scalebug
		--Screecher spirits
	elseif model == "Creature\\WindSerpent\\WindSerpent" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.5, 1.0)
		--Spirit healer
	elseif model == "Creature\\spirithealer\\SpiritHealer" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.3, 1.8)
	elseif model == "Character\\Gnome\\Male\\GnomeMale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.4, 0); storyline.NPC.PlayerFrame:SetModelScale(0.6) -- ok
	elseif model == "Character\\Gnome\\Female\\GnomeFemale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.3, 0); storyline.NPC.PlayerFrame:SetModelScale(0.6) -- ok
	elseif model == "Character\\Dwarf\\Male\\DwarfMale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.5, 0); storyline.NPC.PlayerFrame:SetModelScale(0.7) -- ok
	elseif model == "Character\\Dwarf\\Female\\DwarfFemale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.5, 0); storyline.NPC.PlayerFrame:SetModelScale(0.7) -- ok
	elseif model == "Character\\NightElf\\Male\\NightElfMale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.8, 0); storyline.NPC.PlayerFrame:SetModelScale(0.85) -- ok
	elseif model == "Character\\NightElf\\Female\\NightElfFemale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.7, 0); storyline.NPC.PlayerFrame:SetModelScale(0.8) -- ok
	elseif model == "Character\\Tauren\\Male\\TaurenMale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.6, 0.05); storyline.NPC.PlayerFrame:SetModelScale(0.9) -- ok
	elseif model == "Character\\Tauren\\Female\\TaurenFemale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.6, 0.05); storyline.NPC.PlayerFrame:SetModelScale(0.9) -- ok
	elseif model == "Character\\Troll\\Female\\TrollFemale" then
		storyline.NPC.PlayerFrame:SetModelScale(0.8)                                                -- ok
	elseif model == "Character\\Human\\Female\\HumanFemale" then
		storyline.NPC.PlayerFrame:SetModelScale(0.72)                                               -- ok
	elseif model == "Character\\Scourge\\Female\\ScourgeFemale" then
		storyline.NPC.PlayerFrame:SetModelScale(0.8)                                                -- ok

		-- npc models
	elseif model == "Creature\\HighElf\\HighElfMale_Hunter" then
		storyline.NPC.PlayerFrame:SetFacing(-1.5); storyline.NPC.PlayerFrame:SetPosition(-2, 2.4, 0.7) -- ok
	elseif model == "Creature\\HighElf\\HighElfMale_Mage" then
		storyline.NPC.PlayerFrame:SetFacing(-1.5); storyline.NPC.PlayerFrame:SetPosition(-2, 2.4, 0.7) -- ok
	elseif model == "Creature\\HighElf\\HighElfMale_Priest" then
		storyline.NPC.PlayerFrame:SetFacing(-1.5); storyline.NPC.PlayerFrame:SetPosition(-2, 2.4, 0.7) -- ok
	elseif model == "Creature\\HighElf\\HighElfMale_Warrior" then
		storyline.NPC.PlayerFrame:SetFacing(-1.5); storyline.NPC.PlayerFrame:SetPosition(-2, 2.4, 0.7) -- ok
	elseif model == "Creature\\HighElf\\HighElfFemale_Hunter" then
		storyline.NPC.PlayerFrame:SetPosition(-0.9, 0.8, 0)                                         -- ok
	elseif model == "Creature\\HighElf\\HighElfFemale_Mage" then
		storyline.NPC.PlayerFrame:SetPosition(-0.9, 0.8, 0)                                         -- ok
	elseif model == "Creature\\HighElf\\HighElfFemale_Priest" then
		storyline.NPC.PlayerFrame:SetPosition(-0.9, 0.8, 0)                                         -- ok
	elseif model == "Creature\\HighElf\\HighElfFemale_Warrior" then
		storyline.NPC.PlayerFrame:SetPosition(-0.9, 0.8, 0)                                         -- ok
	elseif model == "Character\\Goblin\\Female\\GoblinFemale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.4, 0.05); storyline.NPC.PlayerFrame:SetModelScale(0.5) --ok
	elseif model == "Character\\Goblin\\Male\\GoblinMale" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.4, 0.05); storyline.NPC.PlayerFrame:SetModelScale(0.5) -- ok
	elseif model == "Creature\\Ghost\\Ghost" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.5, 1.9); storyline.NPC.PlayerFrame:SetModelScale(0.8) -- ok with scalebug
	elseif model == "Creature\\LostOne\\LostOne" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0, 0.7); storyline.NPC.PlayerFrame:SetModelScale(0.95) -- ok with scalebug
	elseif model == "Creature\\FleshGolem\\FleshGolem" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.4, 2); storyline.NPC.PlayerFrame:SetModelScale(0.85 -
			(StorylineOptions.WindowScale - 1)) -- ok with scalebug
	elseif model == "Creature\\Dreadlord\\DreadLord" then
		storyline.NPC.PlayerFrame:SetPosition(0, 1.5, 6.2); storyline.NPC.PlayerFrame:SetModelScale(1 -
			(StorylineOptions.WindowScale - 1)) -- ok with big scalebug
	elseif model == "Creature\\WaterElemental\\WaterElemental" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0, 1.5)
	elseif model == "Creature\\Banshee\\Banshee" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0, 0.2)
	elseif model == "Creature\\GolemHarvestStage2\\GolemHarvestStage2" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.5, 1.8); storyline.NPC.PlayerFrame:SetModelScale(0.7)
	elseif model == "Creature\\Goblin\\GoblinShredder" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.5, 2.5); storyline.NPC.PlayerFrame:SetModelScale(0.7)
	elseif model == "Creature\\OrcMaleKid\\OrcMaleKid" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.2); storyline.NPC.PlayerFrame:SetModelScale(1.5)
	elseif model == "Creature\\OrcFemaleKid\\OrcFemaleKid" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.2, -0.2); storyline.NPC.PlayerFrame:SetModelScale(1.5)
	elseif model == "Creature\\Quillboar\\QuillBoar" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0, 0.4); storyline.NPC.PlayerFrame:SetModelScale(1.2)
	elseif model == "Creature\\Ogre\\Ogre" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.6, 0.2) -- ok
	elseif model == "Creature\\HumanMalePirateCaptain\\HumanMalePirateCaptain" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.8, 0.8); storyline.NPC.PlayerFrame:SetModelScale(1.2 -
			(StorylineOptions.WindowScale - 1))                                                     --ok with scalebug
	elseif model == "Creature\\Gnoll\\gnoll" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.5, 0.2); storyline.NPC.PlayerFrame:SetModelScale(0.95) -- ok
	elseif model == "Creature\\Infernal\\Infernal" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.6, 1.2); storyline.NPC.PlayerFrame:SetModelScale(0.8 -
			(StorylineOptions.WindowScale - 1))                                                    -- ok	with scalebug
	elseif model == "Creature\\Kodobeast\\KodoBeastPack" then
		storyline.NPC.PlayerFrame:SetPosition(0, 0.2, 2.6); storyline.NPC.PlayerFrame:SetModelScale(0.4) -- ok with scalebug
	elseif model == "Creature\\DragonSpawn\\DragonSpawn" then
		storyline.NPC.PlayerFrame:SetPosition(0, 2, 1); storyline.NPC.PlayerFrame:SetModelScale(0.9 -
			(StorylineOptions.WindowScale - 1)) -- ok with scalebug
	end
end
...
function storyline:ShowNPCText(Text, Offset)
	-- set text offset
	if not Offset then
		storyline.Options.Offset = 50
	else
		storyline.Options.Offset = Offset
	end
...
function storyline:HideBlizzard()
	if storyline.Options.HideBlizzardFrames == 1 then
		...
		if Adapt and Adapt.Textures and Adapt.Textures["GossipFramePortrait"] then
			Adapt.Textures["GossipFramePortrait"]:Hide()
		end
		if Adapt and Adapt.Textures and Adapt.Textures["GossipFramePortrait"] and Adapt.Textures["GossipFramePortrait"].modelLayer then
			Adapt.Textures["GossipFramePortrait"].modelLayer:Hide()
		end
		if Adapt and Adapt.Textures and Adapt.Textures["QuestFramePortrait"] then
			Adapt.Textures["QuestFramePortrait"]:Hide()
		end
		if Adapt and Adapt.Textures and Adapt.Textures["QuestFramePortrait"] and Adapt.Textures["QuestFramePortrait"].modelLayer then
			Adapt.Textures["QuestFramePortrait"].modelLayer:Hide()
		end
	else
...
function storyline:UpdateZone()
	...
	-- clear textures
	for i = 1, 11 do
		if self.Background.layer2.Background[i] then
			self.Background.layer2.Background[i].Bg:SetTexture(storyline.Area["Clear"][i])
		end
	end
	...
	if storyline.Area[zoneName] then
		for i = 1, 11 do
			if storyline.Area[zoneName][i] then
				self.Background.layer2.Background[i].Bg:SetTexture(storyline.Area[zoneName][i])
			end
		end
...
function storyline:playPlayerAnimation(event, maxTime)
	storyline.Player.PlayerFrame:SetScript("OnUpdate", function()
		...
		if storyline.Animation.Player > maxTime then
			storyline.Player.PlayerFrame:SetScript("OnUpdate", nil); storyline.Animation.Player = 0
		end
	end)
end
...
function storyline:playNPCAnimation(event, maxTime)
	...
	storyline.NPC.PlayerFrame:SetScript("OnUpdate", function()
		...
		if storyline.Animation.NPC > maxTime then
			storyline.NPC.PlayerFrame:SetScript("OnUpdate", nil); storyline.Animation.NPC = 0
		end
	end)
end
...
function storyline:GreetingsAnimation()
	if storyline.Animation.Database[storyline.NPC.PlayerFrame:GetModel()] then
		local randAnimation = math.random(1,
			storyline:tablelength(storyline.Animation.Database[storyline.NPC.PlayerFrame:GetModel()]))
		local counter = 0
		for key, value in pairs(storyline.Animation.Database[storyline.NPC.PlayerFrame:GetModel()]) do
			counter = counter + 1
			if counter == randAnimation then
				storyline:playNPCAnimation(key, storyline.Animation.Database[storyline.NPC.PlayerFrame:GetModel()][key]); break;
			end
		end
	end
end
...
function storyline:TalkAnimation()
	...
	if storyline.Animation.Database[storyline.NPC.PlayerFrame:GetModel()] and storyline.Animation.Database[storyline.NPC.PlayerFrame:GetModel()][emoteNum] then
		storyline:playNPCAnimation(emoteNum, storyline.Animation.Database[storyline.NPC.PlayerFrame:GetModel()]
			[emoteNum])
	end
end
...
local function TextMenu(arg)
	if arg == nil or arg == "" then
		DEFAULT_CHAT_FRAME:AddMessage("|cFF00FF00Vanilla Storyline:|r This is help topic for |cFFFFFF00 /storyline|r", 1,
			1, 1)
		DEFAULT_CHAT_FRAME:AddMessage("|cFF00FF00Vanilla Storyline:|r |cFFFFFF00 /storyline reset|r - reset scale.", 1, 1,
			1)
		DEFAULT_CHAT_FRAME:AddMessage("|cFF00FF00Vanilla Storyline:|r |cFFFFFF00 /storyline move|r - set moveable.", 1, 1,
			1)
	else
		if arg == "reset" then
			storyline.Background:SetScale(1); storyline.Options.WindowScale = 1; StorylineOptions.WindowScale = 1
		elseif arg == "move" then
			if not storyline.OptionsFrame.MoveButton:GetChecked() then
				storyline.Background:EnableMouse(1); storyline.OptionsFrame.MoveButton:SetChecked(true)
			else
				storyline.Background:EnableMouse(0); storyline.OptionsFrame.MoveButton:SetChecked(false)
			end
		else
...
storyline.Area = {}
storyline.Area["Dun Morogh"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\DunMorogh"
}
storyline.Area["Durotar"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Durotar"
}
storyline.Area["Elwynn Forest"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\ElwynnForest"
}
storyline.Area["Mulgore"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Mulgore"
}
storyline.Area["Teldrassil"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Teldrassil"
}
storyline.Area["Tirisfal Glades"] = {
	[1] = "Interface\\Glues\\Credits\\TirisfallGlades1",
...
storyline.Area["Loch Modan"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\LochModan"
}
storyline.Area["Silverpine Forest"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\SilverpineForest"
}
storyline.Area["Westfall"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Westfall"
}
storyline.Area["The Barrens"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\TheBarrens"
}
storyline.Area["Redridge Mountains"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\RedridgeMountains"
}
storyline.Area["Stonetalon Mountains"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\StonetalonMountains"
}
storyline.Area["Ashenvale"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Ashenvale"
}
storyline.Area["Duskwood"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Duskwood"
}
storyline.Area["Hillsbrad Foothills"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\HillsbradFoothills"
}
storyline.Area["Wetlands"] = { [11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Wetlands" }
storyline.Area["Thousand Needles"] = {
	[1] = "Interface\\Glues\\Credits\\ThousandNeedles1",
...
storyline.Area["Alterac Mountains"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\AlteracMountains"
}
storyline.Area["Arathi Highlands"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\ArathiHighlands"
}
storyline.Area["Desolace"] = {
	[1] = "Interface\\Glues\\Credits\\SouthernDesolace1",
...
storyline.Area["Stranglethorn Vale"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\StranglethornVale"
}
storyline.Area["Dustwallow Marsh"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\DustwallowMarsh"
}
storyline.Area["Badlands"] = {
	[1] = "Interface\\Glues\\Credits\\Badlands1",
...
storyline.Area["Swamp of Sorrows"] = {
	[1] = "Interface\\Glues\\Credits\\SwampofSorrows1",
...
storyline.Area["Feralas"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Feralas"
}
storyline.Area["The Hinterlands"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\TheHinterlands"
}
storyline.Area["Tanaris"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Tanaris"
}
storyline.Area["Searing Gorge"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\SearingGorge"
}
storyline.Area["Azshara"] = {
	[1] = "Interface\\Glues\\Credits\\Ocean1",
...
storyline.Area["Blasted Lands"] = {
	[1] = "Interface\\Glues\\Credits\\BlastedLands1",
...
storyline.Area["Un'Goro Crater"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\UngoroCrater"
}
storyline.Area["Felwood"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Felwood"
}
storyline.Area["Burning Steppes"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\BurningSteppes"
}
storyline.Area["Western Plaguelands"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\WesternPlaguelands"
}
storyline.Area["Deadwind Pass"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\DeadwindPass"
}
storyline.Area["Eastern Plaguelands"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\EasternPlaguelands"
}
storyline.Area["Winterspring"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Winterspring"
}
storyline.Area["Moonglade"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Moonglade"
}
storyline.Area["Silithus"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Silithus"
}
storyline.Area["Blackrock Mountain"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\BlackrockMountain"
}
storyline.Area["Darnassus"] = {
	[1] = "Interface\\Glues\\Credits\\Darnasis1",
...
storyline.Area["City of Ironforge"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Ironforge"
}
storyline.Area["Orgrimmar"] = {
	[1] = "Interface\\Glues\\Credits\\Orccamp1",
...
storyline.Area["Stormwind City"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\StormwindCity"
}
storyline.Area["Thunder Bluff"] = {
	[1] = "Interface\\Glues\\Credits\\ThunderBluff1",
...
storyline.Area["Undercity"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Undercity"
}

storyline.Area["Standard"] = {
	[11] = "Interface\\AddOns\\VanillaStoryline\\Assets\\Images\\Locations\\Standard"
}
storyline.Area["Clear"] = {
	[1] = "",
	[2] = "",
	[3] = "",
	[4] = "",
